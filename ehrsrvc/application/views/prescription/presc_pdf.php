...
<body style="margin:0;padding:0;">
	...
	?>
	<table width="100%" cellspacing="0" cellpadding="0" class="noborder" border="1" style="bborder:0px solid #000;font-family:Verdana, Geneva, sans-serif; font-size:9px !important;">
		<!--
		...
		<tr style="font-size:9px;font-family:Verdana, Geneva, sans-serif;">
			...
			<table width="100%" class="noborder smallFont" >
					<tr>
						<td class="boldStyle">Test Name</td>
